...
rm -rf main.css
echo "@import url('https://raw.githubusercontent.com/Bobcycle/Ptero/master/user.css')" >> /var/www/pterodactyl/resources/scripts/main.css
rm -rf index.tsx
...
wget https://raw.githubusercontent.com/Bobcycle/Ptero/master/admin.blade.php
npm install yarn -g
yarn install
